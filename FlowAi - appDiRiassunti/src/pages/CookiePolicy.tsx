...
import { Globe, Shield, Info, FileText } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-3 px-6 py-2 bg-apple-blue/20 rounded-full mb-8">
            ...
            <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-apple-ink/60">{t('legal.cookies.badge')}</span>
          </div>
        ...
        <div className="space-y-16">
          <section className="apple-card shadow-2xl shadow-black/5 p-12 md:p-16">
            <div className="flex items-center gap-6 mb-10">
              ...
              <h2 className="text-3xl font-display font-bold tracking-tight text-apple-ink">{t('legal.cookies.sections.0.title')}</h2>
            </div>
            <div className="prose prose-lg text-apple-gray font-medium leading-relaxed">
              <p className="mb-6">
                {t('legal.cookies.sections.0.content')}
              </p>
            </div>
          </section>
          ...
          <section className="apple-card shadow-2xl shadow-black/5 p-12 md:p-16">
            <div className="flex items-center gap-6 mb-10">
              ...
              <h2 className="text-3xl font-display font-bold tracking-tight text-apple-ink">{t('legal.cookies.sections.1.title')}</h2>
            </div>
            <div className="prose prose-lg text-apple-gray font-medium leading-relaxed">
              <p className="mb-6">
          ...
          <section className="apple-card shadow-2xl shadow-black/5 p-12 md:p-16">
            <div className="flex items-center gap-6 mb-10">
              ...
              <h2 className="text-3xl font-display font-bold tracking-tight text-apple-ink">{t('legal.cookies.sections.2.title')}</h2>
            </div>
            <div className="prose prose-lg text-apple-gray font-medium leading-relaxed">
              <p className="mb-6">
              ...
              <p>
                For more information on how to manage cookies, please visit <span className="text-apple-blue font-bold">aboutcookies.org</span>.
              </p>
            </div>
          </section>
